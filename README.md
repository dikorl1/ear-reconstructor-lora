...
## 📋 О проекте
Система обучения LoRA-моделей и инпейнтинга для фотореалистичной реконструкции уха на портретах. Поддерживает несколько возрастных групп, разные ракурсы (front/side/back), позы (standing/sitting/supine/prone), а также автоматический QC датасета и балансировку выборки. Генератор изображений - типовой
